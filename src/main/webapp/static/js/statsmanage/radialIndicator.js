...
;(function (factory) {
    ...
    radialIndicator.defaults = {
        radius: 32, //inner radius of indicator
        barWidth: 5, //bar width
        barBgColor: 'rgba(255,255,255,0.4)', //unfilled bar color
        barColor: '#fff', //filled bar color , can be a range also having different colors on different value like {0 : "#ccc", 50 : '#333', 100: '#000'}
