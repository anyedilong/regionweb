...
function tableInit(pageNo){
	...
	var gridTableUrl = roadPath + '/family/org/queryOrgPage';
	$.ajax({
        type: 'POST',
        dataType: "json",
        async: false,
	...
	function openSaveDialog() {
		var url = '/view/basemanage/org/sysorgedit.html?id=' + '';
		var width = 780;
		var height = 490;
		var title = "新增机构信息";
    ...
    function openEditDialog(id){
    	var url = '/view/basemanage/org/sysorgedit.html?id=' + id;
		var width = 780;
		var height = 490;
		var title = "编辑机构信息";
		openDialog(null, url, width, height, title);
    ...
    function deleteRows(id){
        var delUrl = roadPath + '/family/org/delete';
