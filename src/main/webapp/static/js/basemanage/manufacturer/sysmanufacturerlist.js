$(function () {
	...
	function tableInit(pageNo){
		...
		var gridTableUrl = roadPath + '/family/manufacturer/getManufacturerPage';
		$.ajax({
	        type: 'POST',
	        dataType: "json",
	        async: false,
	...
	function openSaveDialog() {
		var url = '/view/basemanage/manufacturer/sysmanufactureredit.html?id=' + '';
		var width = 780;
		var height = 490;
		var title = "新增生产厂商信息";
    ...
    function openEditDialog(id){
    	var url = '/view/basemanage/manufacturer/sysmanufactureredit.html?id=' + id;
		var width = 780;
		var height = 490;
		var title = "编辑生产厂商信息";
		openDialog(null, url, width, height, title);
    ...
    function deleteRows(id){
        var delUrl = roadPath + '/family/manufacturer/delete';
