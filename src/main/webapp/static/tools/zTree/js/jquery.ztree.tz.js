    ...
    var settings = {}, roots = {}, caches = {},
        ...
        view = {
            ...
            makeDOMNodeNameBefore: function (html, setting, node) {
                ...
                var icon = node.icon;
                if (icon == undefined || icon == '') {icon = ' qyhICONS_-';} else { icon = " " + icon; }
                html.push("<a id='", node.tId, consts.id.A, "' class='", consts.className.LEVEL, node.level,  icon,"' treeNode", consts.id.A, " onclick=\"", (node.click || ''),
...
//                    if (icon != undefined && icon.indexOf("static/image/menuIcon") != -1) {
//                    	//icoStyle.push("background:url(", icon, ") 0 0 no-repeat;");
//                    }else{
//                    	icoStyle.push("background:none;");
//                    	
//                    }
